...
describe UserStoriesController do
  ...
  # UserStoriesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET show" do
    it "assigns the requested user_story as @user_story" do
      user_story = UserStory.create! valid_attributes
      get :show, {:id => user_story.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested user_story as @user_story" do
      user_story = UserStory.create! valid_attributes
      get :edit, {:id => user_story.to_param}, valid_session
      assigns(:user_story).should eq(user_story)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new UserStory" do
        expect {
          post :create, {:user_story => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_story as @user_story" do
        ...
        post :create, {:user_story => { "user_id" => "invalid value" }}, valid_session
        assigns(:user_story).should be_a_new(UserStory)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_story" do
        ...
        UserStory.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => user_story.to_param, :user_story => { "user_id" => "1" }}, valid_session
      end

      it "assigns the requested user_story as @user_story" do
        user_story = UserStory.create! valid_attributes
        put :update, {:id => user_story.to_param, :user_story => valid_attributes}, valid_session
        assigns(:user_story).should eq(user_story)
      end
    ...
    describe "with invalid params" do
      it "assigns the user_story as @user_story" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserStory.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_story.to_param, :user_story => { "user_id" => "invalid value" }}, valid_session
        assigns(:user_story).should eq(user_story)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested user_story" do
      user_story = UserStory.create! valid_attributes
      expect {
        delete :destroy, {:id => user_story.to_param}, valid_session
      }.to change(UserStory, :count).by(-1)
    end
